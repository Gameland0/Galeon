...
class LangChainService {
  ...
  async processMessage(message, team, context,combinedKnowledge,blockchainPlatform) {
    ...
    // blockchainPlatform = blockchainPlatform || 'ethereum';
    // console.log("blockchainPlatform:",blockchainPlatform);
  ...
  // async generateCode(task, agentType, context, existingCode = "", blockchainPlatform) {

  //   const prompt = PromptTemplate.fromTemplate(
  //    `
  //     Based on the following task description, generate the corresponding smart contract code:
  //     Task Description: ${task}
  //     Blockchain Type: ${blockchainPlatform}
      
  //     Here are some examples of smart contract structures:
      
  //     // Solana Code Example
  //     ${await this.generateSolanaCode(task)}
      
  //     // Solidity Code Example
  //     ${await this.generateSolidityCode(task)}
      
  //     // TON Code Example
  //     ${await this.generateTonCode(task)}
      
  //     Based on these examples, please generate the appropriate smart contract code.
  //     `
  //   );
