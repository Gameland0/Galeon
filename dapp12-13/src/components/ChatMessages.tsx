          ...
          <div className="selected-entity">
            {selectedSpecificAgent ? (
              ...
              <div className="selected-Team">
                <p>Selected Team: <span>{selectedTeam.name}</span></p >
                <p>Team Agents:</p >
                <ul>
              ...
              <>
                <p className="selectedAgent">Selected Agent: <span>{selectedAgent.name}</span></p >
              </>
            ) : (
              <div className="Tips">No agent or team selected. You can @mention an agent in your message or select a team to chat with.</div >
            )}
          </div>
