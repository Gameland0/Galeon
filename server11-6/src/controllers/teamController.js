...
exports.createTeam = async (req, res) => {
  ...
  try {
    const team = await TeamService.createTeam(req.userId, name, description, agents);
...
exports.updateTeam = async (req, res) => {
  ...
  const { name, description, agents } = req.body;
  try {
    const updatedTeam = await TeamService.updateTeam(teamId, req.userId, { name, description, agents });
