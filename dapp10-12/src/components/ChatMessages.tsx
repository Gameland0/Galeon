...
export const ChatMessages: React.FC = () => {
  const { messages, selectedAgent, selectedTeam, selectedSpecificAgent, setSelectedAgent, setSelectedTeam, showMarketplace, taskDecomposition } = useContext(ChatContext);
